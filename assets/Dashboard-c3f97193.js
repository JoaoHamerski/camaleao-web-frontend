...
`,name:"GraphQL request",locationOffset:{line:1,column:1}};var c={};function N(e){return e.filter(function(n){if(n.kind!=="FragmentDefinition")return!0;var i=n.name.value;return c[i]?!1:(c[i]=!0,!0)})}a.definitions=a.definitions.concat(N(g.definitions));function l(e,n){if(e.kind==="FragmentSpread")n.add(e.name.value);else if(e.kind==="VariableDefinition"){var i=e.type;i.kind==="NamedType"&&n.add(i.name.value)}e.selectionSet&&e.selectionSet.selections.forEach(function(t){l(t,n)}),e.variableDefinitions&&e.variableDefinitions.forEach(function(t){l(t,n)}),e.definitions&&e.definitions.forEach(function(t){l(t,n)})}var u={};(function(){a.definitions.forEach(function(n){if(n.name){var i=new Set;l(n,i),u[n.name.value]=i}})})();function k(e,n){for(var i=0;i<e.definitions.length;i++){var t=e.definitions[i];if(t.name&&t.name.value==n)return t}}function d(e,n){var i={kind:e.kind,definitions:[k(e,n)]};e.hasOwnProperty("loc")&&(i.loc=e.loc);var t=u[n]||new Set,m=new Set,s=new Set;for(t.forEach(function(r){s.add(r)});s.size>0;){var v=s;s=new Set,v.forEach(function(r){if(!m.has(r)){m.add(r);var o=u[r]||new Set;o.forEach(function(S){s.add(S)})}})}return m.forEach(function(r){var o=k(e,r);o&&i.definitions.push(o)}),i}const b=d(a,"GetSalesAmount"),f=d(a,"GetAmountSalesChart"),D=d(a,"GetCitiesSalesAmount"),h=d(a,"GetModelsSalesAmount"),F=d(a,"GetClientsSegmentation");d(a,"DashboardProductionDataParts");d(a,"DashboardProductionOfDayParts");const y=d(a,"GetDashboardProduction"),_=d(a,"ChangeDashboardProductionSettings"),P=d(a,"GetDashboardProductionOrders");export{_ as C,f as G,b as a,D as b,h as c,F as d,P as e,y as f};
